...
func PatchConnection(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	...
	if err := (&models.CodexConnection{}).MergeFromRequest(connection, input.Body); err != nil {
...
func ListConnections(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	var connections []models.CodexConnection
...
func validateConnection(connection *models.CodexConnection) errors.Error {
	if connection == nil {
