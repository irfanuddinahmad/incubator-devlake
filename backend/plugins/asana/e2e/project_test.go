...
func TestAsanaProjectDataFlow(t *testing.T) {
	...
	dataflowTester.ImportCsvIntoRawTable("./raw_tables/_raw_asana_projects.csv", "_raw_asana_projects")
	...
	dataflowTester.VerifyTableWithOptions(models.AsanaProject{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/_tool_asana_projects.csv",
...
func TestAsanaProjectWithScopeConfig(t *testing.T) {
	...
	dataflowTester.VerifyTableWithOptions(models.AsanaProject{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/_tool_asana_projects_with_scope_config.csv",
		IgnoreTypes: []interface{}{common.NoPKModel{}},
	})
}
