...
type PutScopesReqBody = helper.PutScopesReqBody[models.SalesforceScope]
type ScopeDetail = srvhelper.ScopeDetail[models.SalesforceScope, models.SalesforceScopeConfig]
