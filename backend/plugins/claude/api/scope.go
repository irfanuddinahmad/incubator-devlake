...
type PutScopesReqBody = helper.PutScopesReqBody[models.ClaudeScope]
type ScopeDetail = srvhelper.ScopeDetail[models.ClaudeScope, models.ClaudeScopeConfig]

// PutScopes creates or updates Claude organization scopes.
