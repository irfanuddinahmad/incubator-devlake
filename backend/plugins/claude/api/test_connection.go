...
import (
	...
	"github.com/apache/incubator-devlake/plugins/claude/service"
)

// TestConnection validates a Claude connection before saving it.
...
// TestExistingConnection validates a stored Claude connection with optional overrides.
