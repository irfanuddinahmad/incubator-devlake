...
// PostConnections creates a new Claude connection.
...
func PatchConnection(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	...
	if err := (&models.ClaudeConnection{}).MergeFromRequest(connection, input.Body); err != nil {
...
func ListConnections(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	var connections []models.ClaudeConnection
...
func validateConnection(connection *models.ClaudeConnection) errors.Error {
	if connection == nil {
	...
	// organizationId is optional — individual Anthropic accounts do not have one.
	// It is only required when collecting organisation-level usage reports.
	return nil
}
