...
func PatchConnection(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	...
	if err := (&models.HubspotConnection{}).MergeFromRequest(connection, input.Body); err != nil {
...
func ListConnections(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	_ = input
	var connections []models.HubspotConnection
...
func validateConnection(connection *models.HubspotConnection) errors.Error {
	if connection == nil {
