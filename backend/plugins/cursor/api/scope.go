...
type PutScopesReqBody = helper.PutScopesReqBody[models.CursorScope]
type ScopeDetail = srvhelper.ScopeDetail[models.CursorScope, models.CursorScopeConfig]

// PutScopes creates or updates Cursor team scopes.
func PutScopes(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	return dsHelper.ScopeApi.PutMultiple(input)
}

// GetScopeList retrieves scopes for a connection.
func GetScopeList(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	return dsHelper.ScopeApi.GetPage(input)
}

// GetScope returns scope detail for a given scope ID.
...
// DeleteScope removes a scope and optionally its associated data.
