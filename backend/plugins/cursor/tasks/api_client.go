...
// createApiClient initialises an async API client using the connection credentials.
func createApiClient(taskCtx plugin.TaskContext, connection *models.CursorConnection) (*helper.ApiAsyncClient, errors.Error) {
