...
type PlaneEpic struct {
	...
	// Phase 6 keeps only the first assignee, matching Plane work-item extraction.
	AssigneeId    string `gorm:"type:varchar(255)"`
	AssigneeName  string `gorm:"type:varchar(255)"`
	EstimatePoint *float64
	// Point stores Plane's legacy integer point value when estimate_point is absent.
...
func (PlaneEpic) TableName() string {
